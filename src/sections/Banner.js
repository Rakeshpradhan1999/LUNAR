      ...
      <div className="container py-20 pb-48">
        <div className="grid lg:grid-cols-2 gap-8 items-center">
          <div className="mt-28 lg:mt-0">
            <h1 className="text-4xl md:text-6xl font-black text-center lg:text-left">
            ...
            <ul className="grid grid-flow-col gap-4  mx-auto lg:mx-0 max-w-sm w-full text-white mt-20  flex-wrap">
              {iconList.map((v, i) => (
                <li key={i}>
                  <a
                    href={v.link}
