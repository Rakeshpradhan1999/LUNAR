    ...
    <div>
      ...
      <div className="ico-section bg-dark-500 py-10">
        <div className="container">
          <p className="text-primary font-bold text-center text-3xl lg:text-5xl">
            ICO Starts In
          </p>
          <div className="text-white grid justify-center gap-10  grid-flow-col text-center mt-10">
            <div>
      ...
      <div className="bg-white  py-20">
        <div className="container grid sm:grid-cols-3 gap-8">
          {cardData.map((val, i) => (
            <div key={i} className="text-center shadow-lg p-4 py-8 rounded-md">
              <div>
