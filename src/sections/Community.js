...
const Community = () => {
  return (
    <div className="bg-primary pt-20 pb-20 mb-40">
      <div className="container">
        ...
        <div className=" max-w-4xl mx-auto mt-20 grid grid-cols-2 gap-14">
          {social.map((val, i) => (
        ...
        <div className=" grid grid-flow-col gap-4 max-w-xs mx-auto mt-20">
